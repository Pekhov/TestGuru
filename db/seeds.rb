...
Category.create(title: "Внедорожники")
Category.create(title: "Легковые")
Category.create(title: "Коммерческий транспорт")

Test.create(title: "Быстрый тест на принадлежность к внедорожному стилю езды", level: 0, category_id: 1)
Test.create(title: "Тест на знание отличительных особенностей внедорожников", level: 1, category_id: 1)
...
UserHistory.create(user_id: 1, test_id: 1, status: "in process")
